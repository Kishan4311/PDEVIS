""" 
python /summary/summary_mgsm.py \
  --input /evaluation/llama_k40_mgsm_result_point9_gm6_3B_70B_genLen8.json \
  --output /summary/llama_k40_mgsm_summary_point9_gm6_3B_70B_genLen8.json
