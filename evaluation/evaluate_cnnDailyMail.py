...
# coding=utf-8
"""
python /home/iitb/Kishan_SpecDec/_spade2/evaluation/cnndailyMail/evaluate_cnnDailyMail.py \
  --draft_device "cuda:1" \
  --target_device "cuda:2" \
  --dataset "/home/iitb/Kishan_SpecDec/_spade2/Data/cnnDailyMail.json" \
  --code_path "/home/iitb/Kishan_SpecDec/_spade2/appInference2.py" \
  --k 40 \
  --gen_len 128 \
  --gamma 6 \
  --target_model "qwen-30b-I" \
  --drafter_model "qwen-4b-I" \
  --output "/home/iitb/Kishan_SpecDec/_spade2/evaluation/cnndailyMail/qwen_k40_cnn_result_point9_gm6_4B_30B_genLen128.json"
...
def load_cnn_dm(path: str, k: int):
...
def main(args):
    ...
    dataset = load_cnn_dm(args.dataset, args.k)
    # results = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("WMT Evaluation with SPADE")
